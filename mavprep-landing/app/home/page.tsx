              ...
              <ul className="space-y-1">
                <li>
                  <button
                    ...
                    className="flex items-center gap-2 px-2 py-1.5 rounded-md cursor-pointer transition-colors w-full hover:bg-gray-800/50"
                  >
                    <svg
                    ...
                    <span className="text-sm text-gray-200">Past Exams</span>
                  </button>
                </li>
              </ul>
            </div>
