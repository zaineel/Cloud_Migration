        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col items-center text-center space-y-8 py-20">
            ...
            <p className="text-lg sm:text-xl text-gray-300 max-w-2xl">
              Your comprehensive platform for exam preparation, skill
              development, and academic excellence. Join thousands of students
              achieving their goals with our powerful tools and resources.
            </p>
